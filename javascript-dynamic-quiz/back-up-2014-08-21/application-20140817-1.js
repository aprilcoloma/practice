...
for ( i = 0; i < totalQ; i++ ) {
	...
	if ( li.classList.contains("q-1") ) {
		...
		if ( li.classList.contains("active") ) {
			...
			var displayCorrectAnswer = allQuestions[i].correctAnswer;
			console.log("the correct answer is " + displayCorrectAnswer);
			...
			currentItem.addEventListener("click", function() {
				...
				submitAnswer = function() {
					...
					displayCorrectAnswer = allQuestions[counter].correctAnswer;
					console.log("the correct answer is " + displayCorrectAnswer);
